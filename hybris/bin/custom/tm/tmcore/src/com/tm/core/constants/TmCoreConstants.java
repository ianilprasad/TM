 ...
 */
package com.tm.core.constants;

/**
 * Global class for all TmCore constants. You can add global constants for your extension into this class.
 */
public final class TmCoreConstants extends GeneratedTmCoreConstants
{
	public static final String EXTENSIONNAME = "tmcore";


	private TmCoreConstants()
	{
		//empty
	}
