...
import com.tm.test.constants.TmTestConstants;
import com.tm.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = TmTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/tmtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/tmtest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/tmtest/import/cstickets.impex");
			...
			importImpexFile(context, "/tmtest/import/csquotes.impex");
		}
	}
}
