 ...
 */
package com.tm.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(TmFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(TmFulfilmentProcessConstants.PARENT_PROCESS);
