...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/tmstorefront/electronics/en",
						"https://electronics.local:9002/tmstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/tmstorefront/electronics/en",
						"https://electronics.local:9002/tmstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/tmstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/tmstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/tmstorefront/electronics/en",
						"https://electronics.local:9002/tmstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/tmstorefront",
						"https://electronics.local:9002/tmstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/tmstorefront",
						"https://electronics.local:9002/tmstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/tmstorefront/electronics/en",
						"https://electronics.local:9002/tmstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
